...
//  AIChatCourseTests2
//
//  Created by Tung Le on 8/12/2025.
//
...
struct ProfileViewTests {
    ...
    func testLoadDataDoesSetCurrentUser() async throws {
        ...
        #expect(interactor.logger.trackedEvents.contains { $0.eventName == ProfileViewModel.Event.loadAvatarStart.eventName })
    }
    ...
    func testLoadDataDoesSucceedAndAvatarsAreSet() async throws {
        ...
        #expect(events.contains { $0.eventName == ProfileViewModel.Event.loadAvatarSuccess(count: avatars.count).eventName })
    }
    ...
    func testLoadDataDoesFail() async throws {
        ...
        /// Then
        #expect(viewModel.isLoading == false)
        #expect(mockLogService.trackedEvents.contains { $0.eventName == ProfileViewModel.Event.loadAvatarFail(error: URLError(.badURL)).eventName })
    }
    
    @Test("onSettingsButotnPressed")
    func testOnSettingsButotnPressed() async throws {
    ...
    func testOnDeleteAvatarSuccess() async throws {
        ...
        #expect(mockLogService.trackedEvents.contains { $0.eventName == ProfileViewModel.Event.deleteAvatarStart(avatar: avatars[0]).eventName })
    }
