...
struct ActiveABTests: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case createAccountTest = "_202510_CreateAccTest"
        case onboardingCommunityTest = "_202510_OnbCommunityTest"
        case categoryRowTest = "_202510_CategoryRowTest"
        case paywallTest = "_202510_PaywallTest"
    }
...
extension ActiveABTests {
    ...
    init(config: RemoteConfig) {
        ...
        let paywallTestTestStringValue = config.configValue(forKey: ActiveABTests.CodingKeys.paywallTest.rawValue).stringValue
        if let option = PaywallTestOption(rawValue: paywallTestTestStringValue) {
