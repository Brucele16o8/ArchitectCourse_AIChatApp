...
//          /// 1st way to get chat from Firebase (when not knowing the id)
...
//        return result.first
        ...
        /// 2nd way: when you set up the chat id  = user id + avatar id, then using static
