    ...
    ZStack {
        RootView(
            delegate: RootDelegate(
                ...
                onApplicationWillEnterForeground: { _ in // notification in
                    
                },
                onApplicationDidBecomeActive: { _ in // notification in
                    
                },
                onApplicationWillResignActive: { _ in // notification in
                    
                },
                onApplicationDidEnterBackground: { _ in // notification in
                    
                },
                onApplicationWillTerminate: { _ in // notification in
