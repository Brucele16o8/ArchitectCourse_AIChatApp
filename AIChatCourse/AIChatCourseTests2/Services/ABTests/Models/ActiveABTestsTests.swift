...
struct ActiveABTestsTests {
    ...
    func testEventParameters() async throws {
        ...
        #expect(params["test_202510_CreateAccTest"] as? Bool == randomCreateAccountTest)
        #expect(params["test_202510_OnbCommunityTest"] as? Bool == randomOnboardingCommunityTest)
        #expect(params["test_202510_CategoryRowTest"] as? String == randomCategoryRowTest.rawValue)
        #expect(params["test_202510_PaywallTest"] as? String == randomPaywallTest.rawValue)
    }
